...
def run(
    ...
    if training:  # called by train.py
        ...
        # Load model
        model = DetectMultiBackend(weights, device=device, dnn=dnn, data=data, fp16=half, training_onnx=training_onnx)
...
def parse_opt():
    ...
    parser.add_argument("--training-onnx", action="store_true", help="training mode for ONNX inference")
